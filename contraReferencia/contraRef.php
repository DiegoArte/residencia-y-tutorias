...
<head>
    ...
    <title>Formato de Contra Referencia</title>
...
<body>
    ...
    <header class="fixed w-100">
        <a href="../VistaPsicologa1.php" class="back-arrow rounded-pill d-flex justify-content-start">
    ...
    <form id="form" onsubmit="submitForm(); return false;"> <!-- Inicio del formulario -->
        <h3>Formato de Contra Referencia</h3>
        <hr><br>
        ...
        <label for="problematica">Nota de quien recibe la derivación:*</label>
        <textarea id="problematica" name="problematica" rows="4" required></textarea><br>

        <label for="servicioSolicitado">Tipo de servicio recibido:*</label>
