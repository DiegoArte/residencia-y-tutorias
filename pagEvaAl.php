            ...
            <div class="row">
                <div class="col-md-10 offset-md-2">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="form-floating">
                                <input type="text" name="actividad" id="actividad" class="form-control" placeholder="Leave a comment here" required>
                        ...
                        <div class="row mb-3">
                            <div class=" col mb-6">
                                <div class="form-floating">                                
                                    <input type="text" name="periodo" id="periodo" class="form-control" placeholder="Leave a comment here" required>
                        ...
                        <div class="row mb-3">
                            <div class="form-floating">                            
                                <input type="text" name="observaciones" id="observaciones" class="form-control" placeholder="Leave a comment here" required>
                        ...
                        <div class="row mb-3">
                            <div class="form-floating">                            
                                <input class="form-control" type="text" name="valor" id="valor" placeholder="Leave a comment here" required>
                        ...
                        <div class="row mb-3">
                            <div class="form-floating">                            
                                <input class="form-control" type="text" name="nivel" id="nivel" placeholder="Leave a comment here" required>
                                <label for="Nivel"> NIVEL DE DESEMPEÑO ALCANZADO DE LA ACTIVIDAD COMPLEMENTARIA (7)</label>
                                <div class="invalid-feedback">
                                    Completa el campo!!
                                </div>
                            </div>
