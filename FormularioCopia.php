...
<form action="php/guardar_datos.php" method="post" class="formulario">
<h3 style="text-align: center; font-weight: bold; margin-top: 5px;">Plan de Acción Tutorial</h3>
    ...
    <input type="text" id="fecha_actual" name="fecha_actual" required></div>
