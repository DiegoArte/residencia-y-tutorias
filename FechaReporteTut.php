...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<form action="php/guardarFechaRepoTu1.php" method="POST">';
...
$conn=conectar();
// Consulta SQL para obtener las fechas de la tabla fecharepo1
$sql = "SELECT fechaini, fechafin FROM fecharepotu2";
$result = $conn->query($sql);
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        $fechaInicio = $row["fechaini"];
        $fechaFinal = $row["fechafin"];
        echo '<form action="php/guardarFechaRepoTu2.php" method="POST">';
...
$conn=conectar();
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            $fechaInicio = $row["fechaini"];
            $fechaFinal = $row["fechafin"];
            echo '<form action="php/guardarFechaRepoTu3.php" method="POST">';
