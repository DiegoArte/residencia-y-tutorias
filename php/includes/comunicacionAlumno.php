...
$revision=Revision::find("idalumno='$id'  and iddocente='$idsec'");
...
<div class="col">
    <form class="checklist" method="POST" action="">
        ...
        <textarea name="comnombreProyecto" id="" cols="20" rows="2" disabled><?php echo $revision->comnombreProyecto ?></textarea>
        <input name="empresa" type="checkbox" id="02" disabled <?php if($revision->empresa==1){echo "checked";} ?>>
        <label for="02">Empresa</label>
        <textarea name="comempresa" id="" cols="20" rows="2" disabled><?php echo $revision->comempresa ?></textarea>
        <input name="objetivos" type="checkbox" id="03" disabled <?php if($revision->objetivos==1){echo "checked";} ?>>
        <label for="03">Objetivos</label>
        <textarea name="comobjetivos" id="" cols="20" rows="2" disabled><?php echo $revision->comobjetivos ?></textarea>
        ...
        <textarea name="comjustificacion" id="" cols="20" rows="2" disabled><?php echo $revision->comjustificacion ?></textarea>
        ...
        <textarea name="comcronograma" id="" cols="20" rows="2" disabled><?php echo $revision->comcronograma ?></textarea>
        ...
        <textarea name="comdescripcion" id="" cols="20" rows="2" disabled><?php echo $revision->comdescripcion ?></textarea>
    </form>
</div>
