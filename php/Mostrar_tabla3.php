...
function Tabla($nombre2){
    ...
    if ($conn->connect_error) {
        ...
        $sql = "SELECT * FROM `fecha_enviada3` WHERE `Nombre`='".$login."';";
        //echo $sql;
        ...
        if ($resultado->num_rows > 0){
            ...
            <input type="hidden" name="sitio" value="Envio_fechas3.php">
            <input type="hidden" name="datos" value="fecha_enviada3">
